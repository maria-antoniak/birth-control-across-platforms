...
webmd_method_keywords_dict = {'pill': ['sprintec', 'yaz', 'tri-sprintec', 'loestrin', 'lo-loestrin-fe', 'trinessa', 'junel-fe', 'generess-fe', 'mononessa', 'seasonique', 'azurette', 
                                       'minastrin', 'beyaz', 'ocella', 'lutera', 'ortho-tri-cyclen-lo', 'microgestin-fe', 'loryna', 'errin', 'gildess-fe', 'sronyx', 'necon', 
                              ...
                              'iud': ['levonorgestrel-device-3yr', 'liletta-device', 'mirena-device', 'paragard-t-380-a-device', 'skyla-device'],
                              'implant': ['implanon-implant', 'nexplanon-implant', 'norplant-system-kit']}
